...
const SEEDS: Seed[] = [
  ...
  { code: 'PASSPORT_BIOMETRIC', name: 'Biometric Page of Passport', hasExpiry: false, appliesTo: 'PERSON' },
  { code: 'PASSPORT_FULL', name: 'Passport (full copy — current + previous)', hasExpiry: false, appliesTo: 'PERSON' },
  { code: 'DRIVER_LICENCE_FB', name: "Driver's Licence — Front & Back", hasExpiry: false, appliesTo: 'PERSON' },
  { code: 'DRIVER_LICENCE_LOE', name: 'Driver Licence Letter of Entitlement', hasExpiry: true, appliesTo: 'PERSON' },
  { code: 'POLICE_CLEARANCE', name: 'Police Clearance', hasExpiry: true, appliesTo: 'PERSON' },
  { code: 'CERTIFICATES_DIPLOMAS', name: 'Certificates / Diplomas', hasExpiry: false, appliesTo: 'PERSON' },
  ...
  { code: 'PROOF_OF_ADDRESS', name: 'Proof of Current Address', hasExpiry: false, appliesTo: 'PERSON' },
  { code: 'REFERENCE_LETTER', name: 'Reference Letter from Employer', hasExpiry: false, appliesTo: 'PERSON' },
  ...
  { code: 'IRP_CARD', name: 'IRP Card (Irish Residence Permit)', hasExpiry: false, appliesTo: 'PERSON' },
  { code: 'PPS_NUMBER', name: 'PPS Number (card / letter)', hasExpiry: false, appliesTo: 'PERSON' },
  { code: 'UNABRIDGED_BIRTH_CERT', name: 'Unabridged Birth Certificate', hasExpiry: false, appliesTo: 'PERSON' },

  // ── VISA Application (PDF 1 §"VISA Application") ─────────────────────────
  { code: 'RESIDENCY_CARD', name: 'Copy of Residency Card (e.g. SA ID)', hasExpiry: false, appliesTo: 'PERSON' },
  { code: 'JOB_CONTRACT_OFFER', name: 'Signed Job Contract / Employment Offer', hasExpiry: false, appliesTo: 'PERSON' },
  { code: 'APPROVED_WORK_PERMIT', name: 'Copy of Approved Employment Work Permit', hasExpiry: false, appliesTo: 'PERSON' },
  { code: 'DECLARATION_COMPLIANCE', name: 'Declaration of Compliance / Undertaking', hasExpiry: false, appliesTo: 'PERSON' },
  { code: 'PROOF_ACCOMMODATION', name: 'Proof of Accommodation', hasExpiry: false, appliesTo: 'PERSON' },
  { code: 'BANK_STATEMENT', name: 'Bank Statement (last 6 months)', hasExpiry: true, appliesTo: 'PERSON' },
  { code: 'PREVIOUS_VISA_REFUSALS', name: 'Previous Visa Refusals — original letter', hasExpiry: false, appliesTo: 'PERSON' },
